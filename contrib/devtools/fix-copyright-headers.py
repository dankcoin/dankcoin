...
// Copyright (c) 2009-2012 The Dankcoin Core developers
...
CMD_REGEX= "perl -pi -e 's/(20\d\d)(?:-20\d\d)? The Dankcoin/$1-%s The Dankcoin/' %s"
REGEX_CURRENT= re.compile("%s The Dankcoin" % year)

// Copyright (c) 2013-2015 The Dankcoin Core developers
...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CDankcoinAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CDankcoinAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CDankcoinAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CDankcoinAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CDankcoinAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CDankcoinAddress(arr[0].get_str()).Get() == demoAddress.Get());

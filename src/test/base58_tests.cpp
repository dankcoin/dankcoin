...
BOOST_AUTO_TEST_CASE(base58_keys_valid_parse)
{
    ...
    for (unsigned int idx = 0; idx < tests.size(); idx++) {
        ...
        if(isPrivkey)
        {
            ...
            // Note: CDankcoinSecret::SetString tests isValid, whereas CDankcoinAddress does not!

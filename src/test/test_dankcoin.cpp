...
#define BOOST_TEST_MODULE Dankcoin Test Suite

#include "test_dankcoin.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_dankcoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));

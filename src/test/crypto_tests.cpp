...
BOOST_AUTO_TEST_CASE(sha256_testvectors) {
    ...
    TestSHA256("As Dankcoin relies on 80 byte header hashes, we want to have an example for that",
               "f55bd45e7f8e3f10b9ef956a8656d5131b6e2fd1b07b9005882ad36d3f1c642d");

...
#ifndef DANKCOIN_TEST_SCRIPTNUM10_H
#define DANKCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Dankcoin Core 0.10.0, for cross-comparison.
 */
public:

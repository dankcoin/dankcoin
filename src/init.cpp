 ...
 * between dankcoind, and dankcoin-qt and non-server tools.
*/
...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-conf=<file>", strprintf(_("Specify configuration file (default: %s)"), DANKCOIN_CONF_FILENAME));
    if (mode == HMM_DANKCOIND)
    {
#ifndef WIN32
...
#ifndef WIN32
    strUsage += HelpMessageOpt("-pid=<file>", strprintf(_("Specify pid file (default: %s)"), DANKCOIN_PID_FILENAME));
#endif
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/dankcoin/dankcoin>";
    const std::string URL_WEBSITE = "<https://dankcoincore.org>";
...
/** Sanity checks
 *  Ensure that Dankcoin is running in a usable environment with all
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    // Make sure only a single Dankcoin process is using the data directory.

 ...
 */
#ifndef DANKCOIN_UTIL_H
#define DANKCOIN_UTIL_H
...
extern const char * const DANKCOIN_CONF_FILENAME;
extern const char * const DANKCOIN_PID_FILENAME;

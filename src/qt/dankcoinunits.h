...
#ifndef DANKCOIN_QT_DANKCOINUNITS_H
#define DANKCOIN_QT_DANKCOINUNITS_H
...
/** Dankcoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class DankcoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit DankcoinUnits(QObject *parent);

    /** Dankcoin units.
      @note Source: https://en.dankcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        PEPE,
...
typedef DankcoinUnits::Unit DankcoinUnit;

#endif // DANKCOIN_QT_DANKCOINUNITS_H

#!/usr/bin/env python3
# Copyright (c) 2016 The Dankcoin Core developers
...
class SegWitTest(DankcoinTestFramework):
    ...
    def add_options(self, parser):
        parser.add_option("--oldbinary", dest="oldbinary",
                          default=None,
                          help="pre-segwit dankcoind binary for upgrade testing")
    ...
    def setup_network(self):
        ...
        # If an old dankcoind is given, do the upgrade-after-activation test.
    ...
    def test_unnecessary_witness_before_segwit_activation(self):
        ...
        # Right now, dankcoind delays sending reject messages for blocks
    ...
    def test_submit_block(self):
        ...
        # Now redo commitment with the standard nonce, but let dankcoind fill it in.
    ...
    def test_p2sh_witness(self, segwit_activated):
        ...
        # segwit activation.  Note that older dankcoind's that are not
    ...
    # To enable this test, pass --oldbinary=<path-to-pre-segwit-dankcoind> to
    # the test.
    def test_upgrade_after_activation(self, node, node_id):
        print("\tTesting software upgrade after softfork activation")

        assert(node_id != 0) # node0 is assumed to be a segwit-active dankcoind

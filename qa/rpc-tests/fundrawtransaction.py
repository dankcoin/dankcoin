...
class RawTransactionsTest(DankcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid dankcoin address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid dankcoin address" in e.error['message'])

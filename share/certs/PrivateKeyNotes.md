...
unlocked to sign the Dankcoin-Qt.app bundle.
...
allowing somebody to distribute a Dankcoin-Qt.app or dankcoin-qt-setup.exe with a valid
...
that the dankcoin-qt.exe file inside the installer had not been tampered with.

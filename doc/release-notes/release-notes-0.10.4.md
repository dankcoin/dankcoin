Dankcoin Core version 0.10.4 is now available from:

  <https://dankcoin.org/bin/dankcoin-core-0.10.4/>
...
- #6953 `43c2789` Split dankcoin-tx into its own package
- #6953 `dfe0d4d` Include dankcoin-tx binary on Debian/Ubuntu

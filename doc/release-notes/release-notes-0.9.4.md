Dankcoin Core version 0.9.4 is now available from:

  https://dankcoin.org/bin/0.9.4/
...
this update is incompatible with the Dankcoin system and could lead to consensus
forks.

Dankcoin Core released binaries from https://dankcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~dankcoin/+archive/ubuntu/dankcoin
- A third-party or self-compiled Dankcoin Core

upgrade to Dankcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.

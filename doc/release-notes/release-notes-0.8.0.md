Dankcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/dankcoin/files/Dankcoin/dankcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Dankcoin
...
New/changed settings (command-line or dankcoin.conf file)
--------------------------------------------------------

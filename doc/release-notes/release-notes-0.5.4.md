Dankcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/dankcoin/files/Dankcoin/dankcoin-0.5.4/
...
http://gitorious.org/dankcoin/dankcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Dankcoin-Qt notifications under Growl 1.3.
Increase required age of Dankcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxDankcoin properly when installing Dankcoin-Qt over it. (Windows)

Dankcoin Core version 0.9.2.1 is now available from:

  https://dankcoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 PEPE to 0.01 PEPE
...
- Fix "Start dankcoin on system login"
